...
const TitleSectionTypeA: NextPage = () => {
  return (
    <section className="max-w-full flex flex-col items-center justify-center bg-[url('/titlesectiontypea1@3x.png')] bg-cover bg-no-repeat bg-[top] text-center text-17xl text-kasprnet-nero font-text-large self-stretch">
      ...
      <div className="self-stretch flex flex-col items-center justify-start py-0 px-2.5">
        <div className="self-stretch flex flex-row items-center justify-center">
          <div className="self-stretch bg-kasprnet-nero hidden flex-col items-center justify-center py-0 px-[21px] border-[1px] border-solid border-kasprnet-alto">
            <img className="w-[22.5px] relative h-5" alt="" src="/img2.svg" />
          </div>
          <div className="w-80 flex flex-col items-center justify-center">
            <Form.Select className="self-stretch font-text-large text-base text-gray-200 md:hidden">
