...
const MobileMenu: NextPage<MobileMenuType> = ({ onClose }) => {
  return (
    <div className="w-[960px] [background:linear-gradient(#fff,_#fff),_#fff] overflow-y-auto flex flex-col items-start justify-start min-w-[360px] max-w-full max-h-full overflow-auto">
      <div className="self-stretch overflow-hidden shrink-0 flex flex-col items-start justify-start">
        <div className="self-stretch bg-kasprnet-congress-blue flex flex-col items-start justify-start pt-0 px-0 pb-5">
          <div className="self-stretch h-[62px] flex flex-row items-center justify-between py-0 px-4 box-border">
            ...
            <button className="cursor-pointer [border:none] p-0 bg-[transparent] w-12 relative h-12">
              <div className="absolute top-[31.8px] right-[9px] bg-kasprnet-nero w-6 h-0.5 [transform:_rotate(-45deg)] [transform-origin:0_0]" />
              <div className="absolute top-[33.2px] right-[-8px] bg-kasprnet-nero w-6 h-0.5 [transform:_rotate(-135deg)] [transform-origin:0_0]" />
            </button>
          </div>
          <div className="self-stretch bg-kasprnet-congress-blue flex flex-col items-start justify-start gap-[32px]">
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-[3px]">
              ...
              <div className="self-stretch flex flex-col items-center justify-start">
                ...
                <div className="self-stretch bg-darkslateblue flex flex-row flex-wrap items-center justify-start py-2 pr-0 pl-1">
                  <MoMenuSubItem title="회장인사말" />
                  <MoMenuSubItem title="학회정관" />
                  <MoMenuSubItem title="선거관리규정" />
                  <MoMenuSubItem title="학회연혁" />
