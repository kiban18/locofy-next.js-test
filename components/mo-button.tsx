...
const MoButton: NextPage<MoButtonType> = ({ title }) => {
  return (
    <button className="cursor-pointer py-px px-0 bg-[transparent] w-[300px] box-border h-[42px] flex flex-col items-center justify-start max-w-[306px] border-[1px] border-solid border-whitesmoke">
