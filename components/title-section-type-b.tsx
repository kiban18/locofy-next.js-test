...
const TitleSectionTypeB: NextPage = () => {
  return (
    <section className="w-[1440px] max-w-full flex flex-col items-center justify-center bg-[url('/titlesectiontypeb1@3x.png')] bg-cover bg-no-repeat bg-[top] text-center text-17xl text-tailwind-v332-white font-text-large">
      ...
      <div className="self-stretch flex flex-col items-center justify-start py-0 px-10">
        <div className="self-stretch flex flex-row flex-wrap items-center justify-center gap-[1px]">
          <div className="bg-tailwind-v332-white box-border h-10 hidden flex-col items-center justify-center py-0 px-[21px] border-[1px] border-solid border-kasprnet-alto">
            <img className="w-[22.5px] relative h-5" alt="" src="/img2.svg" />
          </div>
          <button className="cursor-pointer [border:none] p-0 bg-tailwind-v332-white-75 w-[200px] flex flex-col items-center justify-start md:hidden">
            <div className="self-stretch h-10 flex flex-row items-center justify-start py-0 px-5 box-border">
              <div className="flex-1 relative text-base tracking-[-0.5px] leading-[16px] font-text-large text-tailwind-v332-gray-800 text-center">
                회장인사말
              </div>
            </div>
          </button>
          ...
          <button className="cursor-pointer [border:none] p-0 bg-tailwind-v332-white-75 w-[200px] flex flex-col items-center justify-start md:hidden">
            <div className="self-stretch h-10 flex flex-row items-center justify-start py-0 px-5 box-border">
              <a
                className="flex-1 relative text-base tracking-[-0.5px] leading-[16px] font-text-large text-tailwind-v332-gray-800 text-center [text-decoration:none]"
