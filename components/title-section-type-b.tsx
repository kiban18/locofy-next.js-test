...
const TitleSectionTypeB: NextPage = () => {
  return (
    <section className="w-[1440px] max-w-full flex flex-col items-center justify-center bg-[url('/titlesectiontypeb@3x.png')] bg-cover bg-no-repeat bg-[top] text-center text-17xl text-kasprnet-nero font-inter">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-center justify-center gap-[1px]">
          ...
          <button className="cursor-pointer [border:none] p-0 bg-gray-300 w-[200px] flex flex-col items-center justify-start md:hidden">
            <div className="self-stretch h-10 flex flex-row items-center justify-start py-0 px-5 box-border">
              <div className="flex-1 relative text-base tracking-[-0.5px] leading-[16px] font-inter text-gray-100 text-center">
                회장인사말
              </div>
            </div>
          </button>
          ...
          <button className="cursor-pointer [border:none] p-0 bg-gray-300 w-[200px] flex flex-col items-center justify-start md:hidden">
            <div className="self-stretch h-10 flex flex-row items-center justify-start py-0 px-5 box-border">
              <a
                className="flex-1 relative text-base tracking-[-0.5px] leading-[16px] font-inter text-gray-100 text-center [text-decoration:none]"
